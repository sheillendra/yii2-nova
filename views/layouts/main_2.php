...
<html>
    ...
    <body id="<?php echo $this->params['bodyId'] ?>" class="lang-it country-gb currency-usd layout-full-width page-index tax-display-enabled
          displayhomenovtwo ">
        <?php $this->beginBody() ?>

        <main id="main-site">
            
            <?php echo $this->render('@app/views/layouts/_header_2', ['novaAsset' => $novaAsset]) ?>

            <?php echo $this->render('@app/views/layouts/_sliderShow_2', ['novaAsset' => $novaAsset]) ?>
            
            <?php if ($this->params['showDisplayTop']): ?>
                <?php echo $this->render('@app/views/layouts/_displayTop_2', ['novaAsset' => $novaAsset]) ?>
            <?php endif; ?>
            ...
            <?php echo $this->render('@app/views/layouts/_footer_2', ['novaAsset' => $novaAsset]) ?>
        ...
        <?php echo $this->render('@app/views/layouts/_mobile_top_menu_wrapper', ['novaAsset' => $novaAsset]) ?>
        <?php $this->endBody() ?>
    </body>
</html>
<?php $this->endPage() ?>